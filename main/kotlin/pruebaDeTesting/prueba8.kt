...
class Prueba8 {
    ...
    private var boton2:     By = By.id("buscar")
    ...
    fun prueba8(username:String, password: String) {
            ...
            when(pwen){
                ...
                3->{
                    try {
                        ...
                        archivoExcel(19, "Unitaria")
                        correoSendGmail("Prueba 8")
                        tearDown()
                        pwen += 1
                        break
                    }catch (e: Exception){
                        archivoExcel(18, "Unitarias")
                        correoSendGmail("Prueba 8")
                        driver!!.quit()
                        break
                    }
